...
function Info(props) {
  return (
    ...
    <div className='skillcontainer' style={{
      border: "1.6px solid rgba(255, 255, 255, 0.22)", borderRadius: " 15px",
    ...
    <div style={{ margin: '40px' }} >
      ...
      {Students.map((e) => {
        return (
          ...
          <Info name={e.name} key = {e.name} Achievement={e.Achievement} Duration={e.Duration} Description={e.Description} />
        );
      })}
    </div>
  );
